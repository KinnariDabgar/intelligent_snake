...
BLOCKED_CELLS = [(60, 10), (50, 10), (40, 10), (30, 10), (20, 10), (70, 10), (80, 10), (90, 10), (100, 10), (100, 20),
                 ...
                 (300, 210), (300, 220), (300, 230), (300, 240), (300,
                                                                  250), (360, 340), (370, 340), (380, 340), (390, 340),
                 (170, 140), (180, 140), (190, 140), (200, 140), (210, 140), (220, 140), (230,
                                                                                          140), (240, 140), (250, 140), (260, 140), (270, 140), (280, 140), (290, 140),
                 (100, 340), (110, 340), (120, 340), (130, 340), (140, 340), (150, 340), (160,
                                                                                          340), (170, 340), (180, 340), (190, 340), (200, 340), (210, 340), (220, 340),
...
def get_adjacent_node(node):
    ...
    for dir in DIRECTIONS:
        ...
        if 0 <= new_pos[0] <= 399 and 0 <= new_pos[1] <= 499:
            list_of_node.append(
...
while running:
    ...
    if dest:
        # pygame.draw.rect(screen, (255, 0, 0), [END[0], END[1], 10, 10])
